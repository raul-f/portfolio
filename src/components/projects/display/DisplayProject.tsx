...
const DisplayProject = props => {
  const sets = {
    ...
    'pomodoro-clock': {
      ...
      description: {
        'en-US': 'An app that allows you to easily manage your time using the Pomodoro Technique.',
        'pt-BR': 'Uma aplicação que permite o gerenciamento de tempo atráves da Técnica Pomodoro.',
      },
    ...
    'drum-machine': {
      ...
      description: {
        'en-US': 'An application that imitates some of the functionalities of a drum machine.',
        'pt-BR': 'Uma aplicação que imita algumas das funcionalidades de uma máquina de ritmos.',
      },
    ...
    'markdown-previewer': {
      ...
      description: {
        'en-US': 'An application that allows the preview of Github-flavored markdown',
        'pt-BR':
    ...
    'treemap-diagram': {
      ...
      description: {
        'en-US': 'A diagram that displays the highest-grossing movies of US cinema.',
        'pt-BR': 'Um diagram que mostra os filmes dos EUA que mais arrecadaram.',
      },
    ...
    xtrack: {
      ...
      description: {
        'en-US': 'The API is in place, but the interface is pending. Check the github repo!',
        'pt-BR':
    ...
    metareader: {
      ...
      description: {
        'en-US': 'A microservice that receives a file and returns its name, size and type.',
        'pt-BR': 'Um microsserviço que recebe um arquivo e retorna o seu tipo, nome e tamanho.',
      },
      link: '',
  ...
  return (
    <div className="display-content-box">
      <div className="display-content">
        ...
        <p className="display-info">{sets[props.active].description[props.language]}</p>
        <div className="display-link-box">
          {sets[props.active].type === 'fullstack' || sets[props.active].type === 'frontend' ? (
            <a
              href={sets[props.active].link ? sets[props.active].link : null}
              target="_blank"
          ...
          {sets[props.active].type === 'fullstack' || sets[props.active].type === 'backend' ? (
            <a href={sets[props.active].repoLink} target="_blank" className="display-repoLink">
              {props.language === 'pt-BR' ? 'Veja no Github ' : 'Check the repo '}
              <i className="fas fa-chevron-right" />
            </a>
          ) : null}
        </div>
